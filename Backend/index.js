...
app.get('/PdfPreview/:type/:name', (req,res) => {
    const fs = require('fs');
    dir = `C:\\Users\\Courtland\\Desktop\\ScannedCourtDocumentProject\\Databases\\PdfPreview\\${req.params.name}-1.jpg`;
...
app.get('/PdfDocument/:type/:name', (req,res) => {
    const fs = require('fs');
    let dir = `C:\\Users\\Courtland\\Desktop\\ScannedCourtDocumentProject\\Databases\\${req.params.type}\\${req.params.name}.pdf`;
